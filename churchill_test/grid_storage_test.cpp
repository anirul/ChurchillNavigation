...
namespace test {
    ...
    TEST_F(GridStorageTest, GridStorageTest_Simple) {
        GridStorage gs(128, 128);
    ...
    TEST_F(GridStorageTest, GridStorageTest_Second) {
        GridStorage gs(128, 128);
        ...
        for (auto it = pl.Begin(); it != pl.End(); ++it) {
            EXPECT_LT(10, it->rank);
            EXPECT_GE(15, it->rank);
        }
    }
